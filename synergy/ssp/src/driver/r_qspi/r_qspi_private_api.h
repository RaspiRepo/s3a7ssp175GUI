...
#ifndef R_QSPI_PRIVATE_API_H
#define R_QSPI_PRIVATE_API_H
...
ssp_err_t R_QSPI_PageProgram (qspi_ctrl_t * p_ctrl,
                              ...
                              uint32_t    byte_count);
ssp_err_t R_QSPI_Erase(qspi_ctrl_t * p_ctrl, uint8_t * p_device_address, uint32_t byte_count);
ssp_err_t R_QSPI_InfoGet(qspi_ctrl_t    * p_ctrl, qspi_info_t    * const p_info);
ssp_err_t R_QSPI_SectorErase (qspi_ctrl_t * p_ctrl, uint8_t * device_address);
ssp_err_t R_QSPI_StatusGet (qspi_ctrl_t * p_ctrl, bool * write_in_progress);
