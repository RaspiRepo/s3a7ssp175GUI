 ...
 * @defgroup SF_WIFI_NSAL_API SF WIFI NSAL Interface
 * @brief RTOS-integrated SF WIFI NSAL Framework Interface.
 *
 * @section SF_WIFI_NSAL_API_SUMMARY Summary
 *
 ...
 * Macro definitions
 **********************************************************************************************************************/
#define SF_WIFI_NSAL_MAC_CHANGED 	(NX_LINK_USER_COMMAND + 1U)
...
{
    NX_INTERFACE        * p_interface;       ///< Pointer to NetX interface
    NX_IP               * p_ip;               ///< Pointer to NetX IP
    sf_wifi_nsal_cfg_t  * p_wifi_nsal_cfg;   ///< pointer to NSAL configuration
} sf_wifi_nsal_callback_args_t;

/*******************************************************************************************************************//**
 * @} (end defgroup SF_WIFI_NSAL_API)
 **********************************************************************************************************************/
