 ...
 * @defgroup SF_WIFI_NSAL_NX SF WIFI NSAL on NetX
 * @brief NetX NSAL interface implementation header file
 *
 * @section SF_WIFI_NSAL_NX_SUMMARY Summary
 *
...
ssp_err_t nsal_netx_driver(NX_IP_DRIVER * driver, sf_wifi_instance_t const * p_wifi_instance,
