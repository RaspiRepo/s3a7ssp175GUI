...
{
    IOPORT_PORT_07_PIN_00,  ///< LED0_R
    IOPORT_PORT_07_PIN_01,  ///< LED1_Y
    IOPORT_PORT_07_PIN_02,  ///< LED2_G
    IOPORT_PORT_07_PIN_03,  ///< LED3_B
};
...
/** @} (end addtogroup BSP_S3_IOT_LEDS) */
