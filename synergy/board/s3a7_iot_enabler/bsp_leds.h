...
/*******************************************************************************************************************//**
 * @ingroup BSP_BOARD_S3_IOT_ENABLER
 * @defgroup BSP_S3_IOT_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the S3 IoT board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
***********************************************************************************************************************/
...
{
    BSP_LED_LED0    = 0,    ///< LED0 Red
    BSP_LED_LED1,           ///< LED1 Yellow
    BSP_LED_LED2,           ///< LED2 Green
    BSP_LED_LED3,           ///< LED3 Blue
} bsp_led_t;
/***********************************************************************************************************************
